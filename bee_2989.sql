...
-- DROP TABLE vencimento cascade;
-- DROP TABLE empregado cascade;
-- DROP TABLE emp_venc cascade;
-- DROP TABLE emp_desc cascade;
-- DROP TABLE divisao cascade;
-- DROP TABLE desconto cascade;
-- DROP TABLE dependente cascade;
-- DROP TABLE departamento cascade;

SELECT departamento.nome, divisao.nome,
        (SELECT ROUND(AVG(vencimento.valor - desconto.valor),2)
        FROM vencimento, desconto
